        ...
        <div className="container-prose py-14">
          <div className="grid gap-10 md:grid-cols-4">
            <div className="md:col-span-2">
              ...
              <p className="mt-4 text-sm text-slate-400">Clinical SOS — the public brand of Clinical Advantage Consultants LLC.</p>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-white mb-3">Explore</h4>
              <ul className="space-y-2 text-sm">
                {NAV_LINKS.map((l) => (
                  <li key={l.path}><Link to={l.path} className="text-slate-300 hover:text-white transition">{l.label}</Link></li>
                ))}
                <li><Link to="/rapid-survey-recovery" className="text-slate-300 hover:text-white transition">Rapid Survey Recovery</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-white mb-3">Take Action</h4>
              <ul className="space-y-2 text-sm">
                <li><Link to="/contact" className="text-slate-300 hover:text-white transition">Request a Consultation</Link></li>
          ...
          <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row justify-between gap-3 text-xs text-slate-400">
